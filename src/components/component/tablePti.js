...
export function TablePti(props) {
    ...
    const [ptiEnPrep, setPtiEnPrep] = useState(props.pti.ptiEnPrep)
        ...
        <Table colorScheme='blue'>
            ...
            <Tbody>
                ...
                <Tr>
                    <Td>PLANIFICATION</Td>
                    <Td>{(props.depense.anterieur/1000000).toFixed(2)}</Td>
                    <Td><Text color='red.400'>{(props.depense.courante/1000000).toFixed(2)}</Text>/{props.projet.prev_courante/1000000}</Td>
